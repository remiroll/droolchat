...
class TheFeedViewController: UIViewController, UIViewControllerTransitioningDelegate {
    ...
    func fetchPosts(){
        ...
        ref.child("posts").queryOrderedByKey().observeSingleEvent(of: .value, with: { snap in
            ...
            for snapshot in snap.children {
                ...
                let posts = Post(snapshot: snapshot)
...
// MARK: - Setup
extension TheFeedViewController {
...
// MARK: - CollectionView 🎛
extension TheFeedViewController: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension TheFeedViewController: GlidingCollectionDatasource {
    
    func numberOfItems(in collection: GlidingCollection) -> Int {
        return postAuthor.count
    }
